# sashanator - Specifications

This folder contains architecture specifications and design documents for **sashanator** features.
...
Check the files in this directory for approved architecture designs and implementation specs for sashanator.
